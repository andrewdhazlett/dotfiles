...
##echo ""
##echo "Displaying ASCII control characters using caret notation in standard text
##views"
...
##defaults write com.apple.BluetoothAudioAgent "Apple Bitpool Min (editable)" -int
##40
# 
#echo ""
...
# 
##echo ""
##echo "Setting a blazingly fast keyboard repeat rate (ain't nobody got time fo
##special chars while coding!)"
...
# 
#echo ""
#echo "Showing icons for hard drives, servers, and removable media on the
#desktop"
...
#/usr/libexec/PlistBuddy -c "Set :DesktopViewSettings:IconViewSettings:arrangeBygrid" ~/Library/Preferences/com.apple.finder.plist
...
# 
#echo ""
#echo "Setting the icon size of Dock items to 36 pixels for optimal
#size/screen-realestate"
